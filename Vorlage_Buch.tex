...
\mainmatter
\include{Kapitel_1}%Grills, Smoker
\include{Kapitel_2}%Tierisch Gut
\include{Kapitel_3}%Gemüse
\include{Kapitel_4}%Leckeres aus dem Holzbackofen
\include {Kapitel_5}%Beilagen
\include{Kapitel_6}% Salate
\include{Kapitel_7}%Gewürze, Saucen und Dips
%\include{Kapitel_7}%Dutch oven
%\include{Kapitel_8}%Holzbackofen
\include{Kapitel_8}%Desserts
\include{Kapitel_9}%Fleischcuts
\include{Kapitel_10}%Helferlein 
